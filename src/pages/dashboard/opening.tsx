...
const Opening: FC<OpeningProps> = ({ days }) => {
    ...
    const { mutate: saveOpeningHours, isLoading } = trpc.opening.changeOpeningHours.useMutation({
            ...
            {!enabled ? (
                <div className='my-12 flex flex-col gap-8'>
                    {days.map((day) => {
                        ...
                        return (
                            <div className='flex justify-center gap-1 items-center grid-cols-3 place-items-center sm:grid' key={day.id}>
                                ...
                                <div className='sm:mx-4'>
                                    <TimeSelector
                                        ...
                                        selected={
                                            openingHours[openingHours.findIndex((x) =>
